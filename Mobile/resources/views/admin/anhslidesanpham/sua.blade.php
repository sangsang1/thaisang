...
<div class="content-page">
        	...
        	<div class="col-lg-7" style="padding-bottom:120px">
				...
				@endif
				<form action="admin/anhslidesanpham/sua/{{$anhslidesp->id}}" method="POST" enctype="multipart/form-data">
					{{ csrf_field() }}
					<div class="form-group">
						<label>Ảnh Trên</label>
						<input type="file" class="form-control" value="" name="anhtren" placeholder="nhập hình ảnh " />
						<img width="100px" height="100px" src="images/anhslidesp/{{$anhslidesp->AnhTren}}" alt="">
					</div>
					<div class="form-group">
						<label>Ảnh Dưới</label>
						<input type="file" class="form-control" value="" name="anhduoi" placeholder="nhập hình ảnh " />
						<img width="100px" height="100px" src="images/anhslidesp/{{$anhslidesp->AnhDuoi}}" alt="">
					</div>
					<div class="form-group">
